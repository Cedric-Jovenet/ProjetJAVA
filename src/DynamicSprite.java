...
public class DynamicSprite extends SolidSprite{
    ...
    private final int tolerance = 5; // 5 pixels
    ...
    public boolean isAtPosition(Sprite sprite) {
        // Vérification si le héros est à proximité du point de sortie avec une certaine tolérance
        double tolerance = 5.0; // Tolérance en pixels
        return Math.abs(this.x - sprite.x) < tolerance && Math.abs(this.y - sprite.y) < tolerance;
    }
